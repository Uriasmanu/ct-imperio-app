...
export const Estoque: React.FC = () => {
  ...
  const [produtoEditando, setProdutoEditando] = useState<ItemEstoque | null>(
    null,
  );
  const [produtoVendendo, setProdutoVendendo] = useState<ItemEstoque | null>(
    null,
  );
  ...
  const calcularTotalPedido = (pedido: Pedido): number => {
    return (
      pedido.total ||
      pedido.itens.reduce((total, item) => total + item.subtotal, 0)
    );
  };
                    ...
                    <View style={styles.itemInfo}>
                      ...
                      {Object.keys(item.tamanhos).length > 0 && (
                        <View style={styles.tamanhosContainer}>
                          <Text style={styles.tamanhosTitulo}>
                            Tamanhos disponíveis:
                          </Text>
                          <View style={styles.tamanhosLista}>
                            {Object.entries(item.tamanhos).map(
                              ([tamanho, qtd]) => (
                ...
                return (
                  <View key={pedido.id} style={styles.pedidoCard}>
                    ...
                    <View style={styles.pedidoHeader}>
                      ...
                      <View
                        style={[styles.statusBadge, { borderColor: statusCor }]}
                      >
                        <Ionicons
                        ...
                        />
                        <Text
                          style={[styles.statusTexto, { color: statusCor }]}
                        >
                          {statusTexto}
                        </Text>
                      </View>
